...
sendMessageTypingAction($chatId);
        ...
        case "/shill":
sendMessageTypingAction($chatId);
                sendMessage($chatId, "<b>Exchange Discounts</b>\n<b>--</b>Trade bitcoin/altcoins up to 100x leverage using bitcoin at http://bitmex.whalepool.io BitMEX\n<b>--</b>Use bitcoin on MetaTrader to trade FOREX, stocks, indices, gold, and more at SimpleFX: http://simplefx.whalepool.io\n<b>--</b>At 1Broker you can trade at up to 200x FOREX, gold, bitcoin, and more: http://1broker.whalepool.io ");
                break;
        case "/shill@FOMO_bot":
sendMessageTypingAction($chatId);
                sendMessage($chatId, "<b>Exchange Discounts</b>\n<b>--</b>Trade bitcoin/altcoins up to 100x leverage using bitcoin at http://bitmex.whalepool.io BitMEX\n<b>--</b>Use bitcoin on MetaTrader to trade FOREX, stocks, indices, gold, and more at SimpleFX: http://simplefx.whalepool.io\n<b>--</b>At 1Broker you can trade at up to 200x FOREX, gold, bitcoin, and more: http://1broker.whalepool.io ");
...
sendMessageTypingAction($chatId);
                $API_KEY = "2OAVpzD4Q7gOX9dSdkd5CAU9";
                $API_SECRET = "mv_pBDYuenGG5Iq2Kt9sFKulUQAittl-ZkjnAp536eD7qCMt";
                ...
                $grab1b = file_get_contents('https://1broker.com/api/v2/user/overview.php?token=A658d1505484522f580475d7194980f4');
                ...
                $totalaccounts=$donationaddie+$communityaddie+$bitmexbalance+$brokerbalance;
...
$API_KEY = 'P4q8QCC_z1iZkP0oi9Qw1EY0';
$API_SECRET = 'pOU0p27KnszfgNVdVWBH4ZkF5T3dVQCqQCp-uajOxU8AVEzt';
...
<b>Whalepool Finances</b>
/current_accounts - show community financial accounts/assets
/community_fund_positions - show the current open positions on active managed community fund\n
<b>Other Commands</b>
/btcusd_ticker - grabs BTCUSD spot exchange prices
